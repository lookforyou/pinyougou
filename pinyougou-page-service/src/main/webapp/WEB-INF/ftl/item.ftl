            ...
            <div class="fl preview-wrap">
                ...
                <div class="zoom">
                    ...
                    <div id="preview" class="spec-preview">
                        <#if (images?size > 0)>
                            <span class="jqzoom"><img jqimg="${images[0].url}" src="${images[0].url}" width="400px"
                                                      height="400px"/></span>
                        </#if>
                    </div>
                    <!--下方的缩略图-->
                        ...
                        <#if specifications??>
                            <#list specifications as spec>
                                <dl>
                                    ...
                                    <#if spec.attributeValue??>
                                        <#list spec.attributeValue as specValue>
                                            <dd>
                                                <a href="javascript:;"
                                                   class="{{isSelected('${spec.attributeName}', '${specValue}') ? 'selected' : ''}}"
                                                   ng-click="selectSpecificationItem('${spec.attributeName}', '${specValue}')">${specValue}
